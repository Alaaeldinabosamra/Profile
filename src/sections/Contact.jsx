...
const Contact = () => {
  return (
    <section id="contact" className="relative relative py-10 px-5 md:px-0">
      <div className="mb-16 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <form className="w-full md:w-1/2 bg-blue-500/50 backdrop-blur-lg rounded-lg border border-blue-300 shadow-lg shadow-blue-500 p-10">
